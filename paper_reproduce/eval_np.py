...
class XRD(Dataset):
    def __init__(self, roots, train=True, num_classes=7, seed=0, train_eval_splits=0.2):
...
if __name__ == "__main__":
    datapath = '/scratch/zzh136/xrd_reproduce/XRD_Pipeline/yufeng/' # '/scratch/zzh136/data/xrd/database_xrds/HighRes2Theta_5to90/ExampleSet/'
    ...
    # model.load_state_dict(torch.load('{}/model.pth'.format(task),map_location=torch.device('cpu')))
