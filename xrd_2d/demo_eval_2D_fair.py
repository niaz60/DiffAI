...
if __name__ == "__main__":
    ...
    label_path = os.path.join(root_path, "Exp9_label_test_20zone.xlsx")
    ...
    df.to_excel("per_class_acc_expT73_dataset_vgg19.xlsx")
    # import pdb;pdb.set_trace()
    ...
    plt.savefig("per_class_acc_expT73_dataset_vgg19.png")
