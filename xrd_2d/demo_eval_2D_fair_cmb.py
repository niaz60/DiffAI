...
if __name__ == "__main__":
    root_path = "/scratch/zzh136/xrd_2d/yufeng_test"# "/scratch/zzh136/xrd_2d/test_t10/test_dataset_10percent"
    train_path = "/scratch/zzh136/xrd_2d/exp5/output/train_files.xlsx"
    val_path = "/scratch/zzh136/xrd_2d/yufeng_test/yufeng_test.xlsx" # "/scratch/zzh136/xrd_2d/test_t10/test_dataset_10percent/test_files.xlsx"
    
    print('begin initialization')
    label_path = "/scratch/zzh136/xrd_2d/yufeng_test/yufeng_test_label.xlsx"# os.path.join(root_path, "label_test_10zone.xlsx")
