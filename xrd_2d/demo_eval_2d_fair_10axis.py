...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("/scratch/zzh136/xrd_2d/redo/redo10/ckpt/vanilla_alexnet.pth"))
    ...
    df.to_excel("redo_per_class_acc_exp_10_dataset_10alexnet.xlsx")
    # import pdb;pdb.set_trace()
    ...
    plt.savefig("redo_per_class_acc_exp_10_dataset_10alexnet.png")
