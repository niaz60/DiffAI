...
if __name__ == "__main__":
    root_path = "/scratch/zzh136/xrd_2d/unseen_test/all_test_16"
    train_path = "/scratch/zzh136/xrd_2d/unseen_test/all_test_16/train_files.xlsx"
    val_path = "/scratch/zzh136/xrd_2d/unseen_test/all_test_16/test_files.xlsx"
    ...
    val_dataset = Dataset(root_path = root_path+'/test_16/', img_path = val_path, label_path = label_path, fmt=True)
    ...
    df.to_excel("redo_per_class_acc_exp_20_dataset_16alexnet.xlsx")
    # import pdb;pdb.set_trace()
    ...
    plt.savefig("redo_per_class_acc_exp_20_dataset_16alexnet.png")
    ...
    df.to_excel("redo_confusion_matrix_10.xlsx")
