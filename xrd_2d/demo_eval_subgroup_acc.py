...
if __name__ == "__main__":
    root_path = "/scratch/zzh136/xrd_2d/output010"
    train_path = "/scratch/zzh136/xrd_2d/output010/train_files.xlsx"
    val_path = "/scratch/zzh136/xrd_2d/output010/val_files.xlsx"
    ...
    model.load_state_dict(torch.load("/scratch/zzh136/xrd_2d/output/ckpt/vanilla_alexnet.pth"))
    ...
    label_mapping = {0: [0,1], 
                    ...
                    2: [i-1 for i in range(16,75)],
                    3: [i-1 for i in range(75,143)],
                    4: [i-1 for i in range(143,168)],
                    5: [i-1 for i in range(168,195)],
                    6: [i-1 for i in range(195,231)]
                    }
    ...
    plt.savefig("class_acc001_010.png")
    ...
    plt.savefig("class_acc_scatter_001_010_scatter.png")
