...
if __name__ == "__main__":
    print('redo10 on alexnet')
    root_path = "/scratch/zzh136/xrd_2d/redo/redo10"
    train_path = "/scratch/zzh136/xrd_2d/redo/redo10/train_files.xlsx"
    val_path = "/scratch/zzh136/xrd_2d/redo/redo10/val_files.xlsx"
    train_root_path = "/scratch/zzh136/xrd_2d/redo/redo10/train"
    val_root_path = "/scratch/zzh136/xrd_2d/redo/redo10/evaluation"

 
    label_path = os.path.join(root_path, "label.xlsx")
    train_dataset = Dataset(root_path = train_root_path, img_path = train_path, label_path = label_path, fmt=True)
    val_dataset = Dataset(root_path = val_root_path, img_path = val_path, label_path = label_path, fmt=True)
