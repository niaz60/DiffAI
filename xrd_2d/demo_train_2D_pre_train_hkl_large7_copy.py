...
if __name__ == "__main__":
    root_path = "/scratch/zzh136/xrd_2d/model_/model3/"
    train_path = "/scratch/zzh136/xrd_2d/model_/model3/train_files.xlsx"
    val_path = "/scratch/zzh136/xrd_2d/model_/model3/val_files.xlsx"
    
    label_path = os.path.join(root_path, "label.xlsx")
    train_dataset = Dataset(root_path = root_path+'/data/',img_path=train_path, label_path = label_path)
    val_dataset = Dataset(root_path = root_path+'/data/', img_path=val_path, label_path = label_path)
