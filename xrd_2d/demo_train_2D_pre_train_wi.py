...
if __name__ == "__main__":
    root_path = "/scratch/zzh136/xrd_2d/output_wi"
    train_path = "/scratch/zzh136/xrd_2d/output_wi/train_files.xlsx"
    val_path = "/scratch/zzh136/xrd_2d/output_wi/val_files.xlsx"
    ...
    model_save_path = os.path.join(root_path, "ckpt", "pretrained_alexnet.pth")
