...
if __name__ == "__main__":
    root_path = "/scratch/zzh136/xrd_2d/re_exp/zone1"
    train_path = "/scratch/zzh136/xrd_2d/re_exp/zone1/train_files.xlsx"
    val_path = "/scratch/zzh136/xrd_2d/re_exp/zone1/val_files.xlsx"
    ...
    model_save_path = os.path.join(root_path, "ckpt", "model_zone1_pretrained_vgg19_hkl_noflip_7.pth")
