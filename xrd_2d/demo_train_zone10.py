...
if __name__ == "__main__":
    root_path = "/scratch/zzh136/xrd_2d/re_exp/zone10/"
    train_path = "/scratch/zzh136/xrd_2d/re_exp/zone10/train_files.xlsx"
    val_path = "/scratch/zzh136/xrd_2d/re_exp/zone10/val_files.xlsx"
    
    label_path = os.path.join(root_path, "label.xlsx")
    train_dataset = Dataset(root_path = root_path+'/meta/',img_path=train_path, label_path = label_path)
    val_dataset = Dataset(root_path = root_path+'/meta/', img_path=val_path, label_path = label_path)
    ...
    model_save_path = os.path.join(root_path, "ckpt", "model_zone10_pretrained_vgg19_hkl_noflip_7.pth")
